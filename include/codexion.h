...
/*   Updated: 2026/08/15 14:53:34 by mbenamar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					log_event(t_simulation *sim, int coder_id,
							char *message);
...
int						has_priority(t_scheduler sched, t_request a,
							t_request b);
void					heap_push(t_dongle *d, t_request req,
							t_scheduler sched);
